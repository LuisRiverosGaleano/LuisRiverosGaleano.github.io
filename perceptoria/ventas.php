	...
	<div class="page-content">
		<div class="container-fluid">
			...
			<div class="box-typical box-typical-padding">
				...
				<h5 class="m-t-lg with-border">Ventas</h5>

				<div class="row">
					<div class="col-lg-1">
						<fieldset class="form-group">
							<label class="form-label semibold" for="exampleInput">Código</label>
							<input autofocus type="text" class="form-control" id="exampleInput" placeholder="">
							
						</fieldset>
					</div>
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputEmail1">Apellido y Nombre</label>
							<input disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="" value="">
						</fieldset>
					</div>
					<div class="col-lg-3">
						<fieldset class="form-group">
							<label  class="form-label" for="exampleInputEmail1">Carrera</label>
							<input disabled type="email" class="form-control" id="exampleInputEmail1" placeholder="" value="">
						</fieldset>
					</div>
					<div class="col-lg-1">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputPassword1">Año</label>
							<input type="text" class="form-control" id="exampleInputPassword1" placeholder="">
						</fieldset>
					</div>
					<div class="col-lg-1">
						<fieldset class="form-group">
							<label class="form-label" for="exampleInputPassword1">Semestre</label>
							<input type="text" class="form-control" id="exampleInputPassword1" placeholder="">
						</fieldset>
					</div>
					<div class="col-lg-1">
				...
				<h5 class="m-t-lg with-border">Lista de Materias</h5>
